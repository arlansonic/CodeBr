...
function addVetor(vetorInicial, vetorFinal){
    for(let i = 0; i < vetorAdciona.length; i++){
        console.log(vetorAdciona[i])
        vetorInicial.push(vetorAdciona[i])
    }

    console.log('Vetor adiciona: '+vetorAdciona)
    console.log('Vetor resultado: '+vetorInicial)
}

addVetor(vetorPilha, vetorAdciona)